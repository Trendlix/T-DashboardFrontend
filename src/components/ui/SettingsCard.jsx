...
function SettingsCard ({srcIcon = '', title, subTitle, iconWidth, iconHeight, cardLink}) {
  return (
    <Link href={cardLink} className='flex flex-col gap-6 w-[25%] h-[170px] px-6 pt-6 bg-white rounded-xl'>
