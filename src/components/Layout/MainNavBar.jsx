  ...
  return (
    <nav className='flex flex-row h-28 bg-white py-2 items-center justify-around'>
      <div className="flex flex-col gap-1">
        <h1 className="font-bold text-3xl">Hi, Marcelo!</h1>
        <p className="text-gray-400 text-md">Let's check your website today</p>
      </div>
      ...
      <div className="flex flex-row gap-8 items-center md:ml-[-90px]">
      ...
      <div className="flex flex-row items-center gap-8 md:ml-[-62px]">
